namespace ReSharperPlugin.Actions
{
  ...
  public static class Resources
  {
    ...
    public static string CopyPathActionText => ResourceManager.GetString("CopyPathActionText");
    public static string OpenPathInBrowserActionText => ResourceManager.GetString("OpenPathInBrowserActionText");
    public static string CopyPathActionDialogCaption => ResourceManager.GetString("CopyPathActionDialogCaption");
    public static string CopyPathActionDescription => ResourceManager.GetString("CopyPathActionDescription");
  }
}